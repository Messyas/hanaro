...
class ScrapAutomationExecution(Base):
    ...
    task_id: Mapped[str | None] = mapped_column(String(100), index=True, default=None)
    ingestion_payload: Mapped[dict[str, Any] | None] = mapped_column(JSON_TYPE, default=None)
