...
from src.app.models.tier.schemas import TierRead
...
from src.app.support.tier.dependencies import TierServiceDep
from src.infrastructure.auth.http_exceptions import NotFoundException
...
@router.get(
    ...
    summary="List tiers",
    responses={500: {"description": "An unexpected error occurred"}},
)
async def get_tiers(
    db: AsyncSessionDep,
