...
from src.app.support.api_keys.dependencies import APIKeyServiceDep
...
from src.infrastructure.dependencies import AsyncSessionDep, CurrentUserDep

router = APIRouter(tags=["API Keys"])

INTERNAL_SERVER_ERROR = "Internal server error"
API_KEY_ID_DESCRIPTION = "API key ID"
...
async def get_api_key(
    ...
    api_key_service: APIKeyServiceDep,
    db: AsyncSessionDep,
    key_id: int = Path(..., description=API_KEY_ID_DESCRIPTION),
) -> dict[str, Any]:
