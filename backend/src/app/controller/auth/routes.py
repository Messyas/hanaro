...
from src.app.support.user.dependencies import UserServiceDep
...
@router.post(
    ...
    description="""
            ...
            """,
    responses={
        200: {"description": "New CSRF token generated successfully"},
        401: {"description": "Not authenticated"},
    },
...
async def check_auth(
    ...
    try:
        user = await user_service.get_active_by_id(principal.user_id, db)
