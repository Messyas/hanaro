...
from src.app.support.user.dependencies import ProfileImageStorageDep, UserServiceDep
from src.app.support.user.profile_image import (
    ALLOWED_IMAGE_CONTENT_TYPES,
    DEFAULT_PROFILE_IMAGE_URL,
    ProfileImageValidationError,
)
from src.infrastructure.auth.http_exceptions import HTTPException
...
async def list_managed_users(
    ...
    from src.app.models.user.models import User  # noqa: PLC0415
