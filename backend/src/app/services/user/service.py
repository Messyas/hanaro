...
from src.app.models.rate_limit.schemas import RateLimitRead
...
class UserService:
    ...
    async def get_active_by_id(self, user_id: int, db: AsyncSession) -> dict[str, Any] | None:
        """Return an active user for authentication status responses."""
