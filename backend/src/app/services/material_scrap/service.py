...
from src.app.models.material_scrap.schemas import IngestionResult, MaterialScrapPayload
from src.app.repository.material_scrap import repository
from src.app.services.material_scrap.classification_service import ScrapClassificationService
from src.app.services.material_scrap.execution_service import ensure_execution_from_payload, link_ingestion_result
...
async def ingest_material_scrap(payload: MaterialScrapPayload, db: AsyncSession, *, attempt: int = 1) -> IngestionResult:
    ...
    try:
        ...
        await link_ingestion_result(payload, db, ingestion_run_id=None, is_replay=False, failed=error, attempt=attempt)
        logger.exception(
