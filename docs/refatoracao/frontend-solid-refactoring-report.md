...
- [x] Move Action Plans and Alerts into their respective module folders with feature routes; keep their state at the route component until dedicated state extraction.
