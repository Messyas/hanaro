...
| --- | --- | --- | --- |
| FE-SOLID-01 | P1 | In progress — export, API client, editor, list, capability and preview state extracted | Split Reports vertically. The route shell no longer owns export polling, DOM download, source mutation, and every editor section; current URLs and behavior remain unchanged. |
